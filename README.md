...
- 消防与用电安全
  ...
  - ❤️B2类必会知识技能
    ...
    1. 灭火毯、卷盘、防火卷帘门的使用
    1. 防火卷帘门下禁止堆物的检查，凸透镜类物品（眼镜、水瓶、水桶、车载香水、水晶球）聚光隐患的发现
  - ❤️C1类必会知识技能
    1. 动火作业的监督：作业类型、资格
    ...
    1. 防火门的组件及其检查
    1. 组织群众疏散，疏散指示灯相关
    1. 建筑消防水系统（自动喷淋、消火栓等）原理，水箱、报警阀组、末端试水的非接触式检查
    1. 可燃气体报警装置的原理与检查，独立式烟感/气体检测的使用，火灾显示盘的检查
